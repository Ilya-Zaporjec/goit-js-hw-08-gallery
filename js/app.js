...
ref.gallery.insertAdjacentHTML('afterbegin', GalleryMarkup);
...
ref.lightboxCloseBtn.addEventListener('click', closeLightbox)
...
function openLightbox(target) {
    ...
    if (target.src === preview) {
        ref.lightboxImage.src = `${original}`;
      ref.lightboxImage.alt = `${description}`;
    }
  });
    window.addEventListener('keydown', closeLightbox);
    ref.lightboxOverlay.addEventListener('click',closeLightbox)
};
